...
const SpotifyIcon = ({size}) => {
   return(
    <svg height={size}  width={size}  viewBox="0 0 16 16" xmnls="http://www.w3.org/2000/svg">
...
const PlayIcon = ({size}) => {
   return(
    <svg height={size}  width={size}  viewBox="0 0 24 24" xmnls="http://www.w3.org/2000/svg">
       <path d="M7.05 3.606l13.49 7.788a.7.7 0 010 1.212L7.05 20.394A.7.7 0 016 19.788V4.212a.7.7 0 011.05-.606z" fill="black"
       />
        </svg>
   )
}
...
const FullScreenRightIcon = ({size}) => {
   return(
    <svg height={size}  width={size}  viewBox="0 0 16 16" xmnls="http://www.w3.org/2000/svg">
...
const FullScreenRightOffIcon = ({size}) => {
   return(
    <svg height={size}  width={size}  viewBox="0 0 24 24" xmnls="http://www.w3.org/2000/svg">
...
const PictureInPictireIcon = ({size}) => {
   return(
    <svg height={size}  width={size}  viewBox="0 0 16 16" xmnls="http://www.w3.org/2000/svg">
   <path d="M1 3v9h14V3H1zm0-1h14a1 1 0 0 1 1 1v10a1 1 0 0 1-1 1H1a1 1 0 0 1-1-1V3a1 1 0 0 1 1-1z" fill="currentColor"
   />
...
const Icon = ({ name, size = 24}) => {
    ...
    const icons ={
        ...
        fullScreenRight: FullScreenRightIcon,
        fullScreenRightOff: FullScreenRightOffIcon,
        pictireInPicture: PictureInPictireIcon,
        device: DeviceIcon,
