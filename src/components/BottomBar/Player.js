...
function Player() {
    ...
    return(
     ...
     <div className="min-w-[11.25rem] w-[30%]">
       {current &&(
         ...
         <div className="w-14 h-14 mr-3 relative flex-shrink-0 group">
           ...
           className="w-6 h-6 bg-black rounded-full absolute top-1 right-1 opacity-0 group-hover:opacity-60 hover:!opacity-100 hover:scale-[1.06] flex items-center justify-center">
      ...
      <button className="w-8 h-8 flex items-center justify-center text-white text-opacity-70 hover:text-opacity-100">
             <Icon size={16} name="pictireInPicture" />
             </button>
      </div>
       )}
     ...
     onClick={toggle}
     className="w-8 h-8 flex items-center justify-center text-white text-opacity-70 hover:text-opacity-100">
        <Icon size={16} name="fullScreenRight" />
     </button>
     </div>
     <div ref={fsRef}>
       {isFullscreen && (
